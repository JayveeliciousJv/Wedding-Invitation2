                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    >
                      ...
                      {/* Zoom badge */}
                      <div className="absolute top-3 right-3 flex items-center gap-1.5 bg-white/90 backdrop-blur-sm text-[#1a1a1a] text-[10px] tracking-[0.2em] uppercase px-3 py-1.5 rounded-full shadow opacity-0 group-hover:opacity-100 transition">
                        <ZoomIn size={12} />
                        Expand
                      </div>
                      ...
                      <div className="absolute bottom-0 left-0 right-0 flex items-end justify-between p-4 md:p-5">
                        ...
                        <a
                          ...
                          rel="noopener noreferrer"
                          onClick={(e) => e.stopPropagation()}
                          className="flex items-center gap-1.5 bg-white/20 hover:bg-white/30 backdrop-blur-sm border border-white/30 text-white text-[10px] tracking-[0.2em] uppercase px-3 py-2 rounded-full transition"
                        >
        ...
        {lightbox && (
          ...
          >
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 flex justify-between bg-black/60 px-5 py-3">
                <div>
                  <p className="text-[9px] uppercase text-white/60">
                    {current.label}
                  </p>
                  <p className="text-white">{current.place}</p>
                </div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-gold text-[#1a1a1a] text-[10px] uppercase rounded-full"
                >
                  <Navigation size={13} />
                  Get Directions
                </a>
